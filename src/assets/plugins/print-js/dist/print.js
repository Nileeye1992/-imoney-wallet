...
/* harmony default export */ __webpack_exports__["default"] = ({
  print: function print(params, printFrame) {
    ...
    var toObject = function(req1) {
      try {
        return JSON.parse(new TextDecoder().decode(req1.response));
      }catch{
    ...
    req.addEventListener('error', function () {
      ...
      // console.log(toObject(req));
      params.onError(toObject(req) || req.statusText); // Since we don't have a pdf document available, we will stop the print job
    });
